...
OVIRT_TO_IRONIC_DEVICE_MAPPING = {v: k
                       for k, v in IRONIC_TO_OVIRT_DEVICE_MAPPING.items()}
...
def _getvm(driver_info):
    host, port, user, password = driver_info['host'], driver_info['port'], driver_info['user'], driver_info['password']
