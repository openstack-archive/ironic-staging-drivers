...
def _parse_driver_info(node):
    ...
    driver_info = conf_info.copy()
    driver_info.update(node_info)
    missing_info = [key for key in PROPERTIES if not driver_info.get(key)]
    if missing_info:
        msg = _("Missing ovirt_vm_name in the node's driver_info")
