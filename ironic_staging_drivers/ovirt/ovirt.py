...
OVIRT_TO_IRONIC_POWER_MAPPING = {
    ...
    'error': states.ERROR,
    'image_locked': states.POWER_DOWN,
    'migrating': states.POWER_ON,
    'not_responding': states.ERROR,
    'paused': states.ERROR,
    'powering_down': states.POWER_DOWN,
...
opts = [
    ...
    cfg.StrOpt('insecure',
               default=False,
               help='oVirt insecure mode. Skips verification of the oVirt host certificate'),
    cfg.StrOpt('ca_file',
...
def _parse_driver_info(node):
    ...
    if 'vmname' not in d_info:
        msg = _("Missing vmname's information")
