...
def _parse_driver_info(node):
    ...
    if d_info['vm_name'] is None or d_info['vm_name'] == '':
        msg = _("Missing vm_name in the node's driver_info")
...
class oVirtManagement(base.ManagementInterface):
    ...
    def get_boot_device(self, task):
        ...
        raise staging_exception.oVirtError("oVirt returned unknown boot "
                                           "device %s for node %s"
                                           % (boot_dev, task.node.uuid))
