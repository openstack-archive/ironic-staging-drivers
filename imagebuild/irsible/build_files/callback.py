...
def main():
    ...
    inspector_url =  kernel_params.get('ipa-inspection-callback-url')
    # TODO(aarefiev): change default driver
    ironic_driver = kernel_params.get('callback-driver-name', 'pxe_ssh_ansible')

    if api_url is None or (deployment_id is None and not inspector_url):
    ...
    if inspector_url:
        data['inspector_url'] = inspector_url
